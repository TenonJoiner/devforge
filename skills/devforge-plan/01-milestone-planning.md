...
1. 读取 `templates/plan-milestone.md`，识别各章节的决策权重分布
...
- **模板约束**：使用 `templates/plan-milestone.md`
...
- **执行**：
  - 按 `templates/plan-milestone.md` 模板组装
...
- **被评审 template 路径**：`templates/plan-milestone.md`（视角来源 1：reviewer 从其 mandatory-sections + 自检清单提取评审锚点）
