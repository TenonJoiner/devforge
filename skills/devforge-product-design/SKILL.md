...
> **内容规范强牵引**：架构交付件的所有内容结构、章节要求、自检清单**以 `templates/*.md` 为唯一准绳**。本 skill 只负责定义**努力程度、写作风格、质量门槛和流程控制**，不再重复模板中已有的内容要求。
...
2. **template_path**（如 `templates/arch-system.md` / `templates/arch-adr.md` / `templates/arch-subsystem.md`）
...
2. **被评审 template 路径**（如 `templates/ref-architecture.md`，指示视角来源 1）
